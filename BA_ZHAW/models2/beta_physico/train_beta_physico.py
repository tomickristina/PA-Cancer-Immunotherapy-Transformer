...
def main():
    ...
    train_physico_epi = f"{physico_base_dir}/train_beta_epitope_{precision}_physico.npz"
    train_physico_trb = f"{physico_base_dir}/train_beta_TRB_{precision}_physico.npz"
    test_physico_epi = f"{physico_base_dir}/test_beta_epitope_{precision}_physico.npz"
    test_physico_trb = f"{physico_base_dir}/test_beta_TRB_{precision}_physico.npz"
